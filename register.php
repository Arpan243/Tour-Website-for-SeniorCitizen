...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT id FROM `users` WHERE `users`.`mobile` = '$myusername' AND `users`.`password`='$mypassword';";
    ...
    //    session_register("myusername");
       ...
       header("location: login.php");
        ...
        $insert_user = $db->prepare("INSERT INTO `users`(name, mobile, password) VALUES(?,?,?)");
